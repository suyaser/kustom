 ...
 * (M5.34) — so a link pasted from one lands on the same window in another. The boundaries themselves are `lib/night.ts` (M5.9); this file
...
/**
 * `/1v1` opens on `All time` (M5.34): a lane series is rarer than a person's games at a
